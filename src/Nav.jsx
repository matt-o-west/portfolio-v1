...
const Nav = () => {
  return (
    <div className='absolute w-full pl-10 z-50'>
      ...
      <div className='flex flex-row z-40 max-w-sm min-w-full space-x-4 justify-end pr-36 ml-24 xl:ml-4 md:ml-12 max-[360px]:p-4 max-[360px]:pl-10 lg:pr-52 md:scale-125 xl:scale-150 xl:pr-96 xl:translate-x-8'>
